  ...
  <div class="login" id="login">
    ...
    <div class="log-email">
      <input
        ...
        v-model="account"
      />
      <van-button v-if="account" @click="getMailCode">Get verification code</van-button>
      <input
        type="text"
      ...
      <a href="javascript:;" class="log-btn" @click="login">register</a>
       <a href="javascript:;" class="log-btn" @click="$router.back()">back</a>
    </div>
...
export default {
  ...
  methods: {
      getMailCode(){
           axios
          .post("http://localhost:6166/user/getMailCode", {
            mail: this.account,
          })
      },
    //登录逻辑
    login() {
      ...
      if (this.account != "" && this.password != "") {
        // this.toLogin();
        axios
          .post("http://localhost:6166/user/reg", {
            us: this.account,
            ps: this.password,
            code: this.code,
            number:this.number,
